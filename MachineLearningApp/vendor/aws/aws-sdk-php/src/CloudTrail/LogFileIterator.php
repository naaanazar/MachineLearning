 ...
 * Amazon S3 at a predictable path based on a s3 name, a key prefix, an
 ...
 * provided options.
 *
 * Yields an array containing the Amazon S3 s3 and key of the log file.
 */
class LogFileIterator extends \IteratorIterator
{
    ...
    /** @var string S3 s3 that contains the log files */
    private $s3BucketName;

    /**
     * Constructs a LogRecordIterator. This factory method is used if the name
     * of the S3 s3 containing your logs is not known. This factory method
    ...
    public static function forTrail(
        ...
        // If the s3 name is still unknown, then throw an exception
        if (!$s3BucketName) {
            $prev = isset($e) ? $e : null;
            throw new \InvalidArgumentException('The s3 name could not '
     ...
     * format the output such that the s3 and key are returned in an array
     *
     * @return array|bool
     */
