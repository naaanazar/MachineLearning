    ...
    <div class="col-lg-8 col-md-8 col-ms-8 col-xs-8">
        <form class="form-horizontal" method="post" action="#">
            <div class="form-group">
                ...
                <input id="email" name="email_custom_domain" type="text" class="form-control batch-input" placeholder="Email custom domain">
            </div>
            <div class="form-group">
                <label for="same-email" class="control-label batch-label text-right">Same email domain count</label>
                <input id="same-email" name="same_email_domain_count" type="text" class="form-control batch-input" placeholder="Same email domain count">
            </div>
            <div class="form-group">
                <label for="projects-count" class="control-label batch-label text-right">Projects count</label>
                <input id="projects-count" name="projects_count" type="text" class="form-control batch-input" placeholder="Projects count">
            </div>
            <div class="form-group">
                <label for="string-count" class="control-label batch-label text-right">Strings count</label>
                <input id="string-count" name="strings_count" type="text" class="form-control batch-input" placeholder="Strings count">
            </div>
            <div class="form-group">
                <label for="members-count" class="control-label batch-label text-right">Members count</label>
                <input id="members-count" name="members_count" type="text" class="form-control batch-input" placeholder="Members count">
            </div>
            <div class="form-group">
                <label for="has-privat-project" class="control-label batch-label text-right">Has private project</label>
                <input id="has-privat-project" name="has_private_project" type="text" class="form-control batch-input" placeholder="Has private project">
            </div>
            <div class="form-group">
                <label for="same-log-project" class="control-label batch-label text-right">Same login and project name</label>
                <input id="same-log-project" name="same_login_and_project_name" type="text" class="form-control batch-input" placeholder="Same login and project name">
            </div>
            <div class="form-group">
                <label for="last-login" class="control-label batch-label text-right">Days after last login</label>
                <input id="last-login" name="days_after_last_login" type="text" class="form-control batch-input" placeholder="Days after last login">
            </div>
            <div class="form-group">
                <label for="country" class="control-label batch-label text-right">Country</label>
                <input id="country" name="country" type="text" class="form-control batch-input" placeholder="Country">
            </div>
            <div class="form-group">
