...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <ul class="nav navbar-nav">
            <li {{ (Request::is('predictions') ? 'class=active' : '') }}><a
                        href="{{ action('S3Controller@predictionForm') }}">Predictions</a></li>
            <li {{ (Request::is('ml') ? 'class=active' : '') }}><a href="{{ action('MLController@index') }}">ML</a></li>
            <li {{ (Request::is('s3/list') ? 'class=active' : '') }}><a href="{{ action('S3Controller@listS3') }}">List S3</a></li>
            <li {{ (Request::is('generator') ? 'class=active' : '') }}><a href="{{ URL::to('generator') }}">Generator</a></li>
            <li {{ (Request::is('bucket/listBucket') ? 'class=active' : '') }}><a href="{{ action('BucketController@index') }}">Bucket</a></li>





            <li><a href="s3/create_bucket" class="btn btn-primary">Create Bucket</a></li>
            <li><a href="s3/list_of_buckets" class="btn btn-primary">List of Buckets</a></li>
        </ul>
    </div>
</nav>
...
<a id="back-to-top" href="#" class="btn btn-primary btn-lg back-to-top" role="button" title="Back to Top"
