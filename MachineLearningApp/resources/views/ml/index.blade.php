...
@section('content')
    ...
    <div class="container">
        <div class="col-md-6">
            <h2 class="title"><img class="logo-s3" src="{{ URL::to('images/aws-ML.png') }}" alt="ml">Machine Learning
            </h2>
        </div>
        ...
        <div class="col-md-12">
            <div class="col-md-8">
                <ul class="nav nav nav-pills nav-justified">
                    ...
                    <li><a href="#modal" role="button" class="btn" data-toggle="modal">Click Me</a></li>
                </ul>
            </div>
            ...
            <div class="tab-content">
                <div id="describeDataSources" class="tab-pane fade in active">
                    <div class="col-md-4">
                        ...
                        <form class="create-datasource" method="post"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm btn-list"
                                       href="/ml/getdatasource/{{ $value['DataSourceId'] }}" data-toggle="modal"><span
                                                class="glyphicon glyphicon-info-sign"></span></a>
                                    <a class="btn btn-danger btn-sm btn-list"
                                       href="/ml/delete/{{ $value['DataSourceId'] }}"><span
                ...
                <div id="describeMLModels" class="tab-pane fade">
                    <div class="col-md-4">
                        ...
                        <form class="create-mlmodel" method="post"
                              action="{{ action('MLController@createDataSourceFromS3') }}">
                            <br>
                            {{ csrf_field() }}
                            <div class="form-group">
                    ...
                    <table class="table table-bordered table-font text-center">
                        ...
                        @foreach($result['describeMLModels'] as $key => $value)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm btn-list"
                                       href="/ml/getdatasource/{{ $value['MLModelId'] }}" data-toggle="modal"><span
                                                class="glyphicon glyphicon-info-sign"></span></a>
                                    <a class="btn btn-danger btn-sm btn-list"
                                       href="/ml/delete/{{ $value['MLModelId'] }}"><span
                                                class="glyphicon glyphicon-trash"></span></a>
                                </td>
                            </tr>
                        @endforeach
                ...
                <div id="describeEvaluations" class="tab-pane fade">
                    <div class="col-md-4">
                        ...
                        <form class="create-evaluations" method="post"
                              action="{{ action('MLController@createDataSourceFromS3') }}">
                            <br>
                            {{ csrf_field() }}
                            <div class="form-group">
                    ...
                    <table class="table table-bordered table-font text-center">
                        ...
                        @foreach($result['describeEvaluations'] as $key => $value)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm btn-list"
                                       href="/ml/getdatasource/{{ $value['EvaluationId'] }} " data-toggle="modal"><span
                                                class="glyphicon glyphicon-info-sign"></span></a>
                                    <a class="btn btn-danger btn-sm btn-list"
                                       href="/ml/delete/{{ $value['EvaluationId'] }}"><span
                                                class="glyphicon glyphicon-trash"></span></a>
                                </td>
                            </tr>
                        @endforeach
                ...
                <div id="describeBatchPredictions" class="tab-pane fade">
                    <div class="col-md-4">
                        <button class="btn btn-primary btn-create-bath-description pull-right">Create Bath Description
                        </button>
                        <form class="create-bath-description" method="post"
                              action="{{ action('MLController@createDataSourceFromS3') }}">
                            <br>
                            {{ csrf_field() }}
                            <div class="form-group">
                    ...
                    <table class="table table-bordered table-font text-center">
                        ...
                        @foreach($result['describeBatchPredictions'] as $key => $value)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm btn-list"
                                       href="/ml/getdatasource/{{ $value['BatchPredictionId'] }}" data-toggle="modal"><span
                                                class="glyphicon glyphicon-info-sign"></span></a>
                                    <a class="btn btn-danger btn-sm btn-list"
                                       href="/ml/delete/{{ $value['BatchPredictionId'] }}"><span
                                                class="glyphicon glyphicon-trash"></span></a>
                                </td>
                            </tr>
                        @endforeach
