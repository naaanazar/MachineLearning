...
require_once 'Sorters/DiagonalSorter.class.php';
require_once 'Sorters/SnakeSorter.class.php';
require_once 'Sorters/SpiralSorter.class.php';
require_once 'Sorters/StandartSorter.class.php';
require_once 'Sorters/VerticalSorter.class.php';

// Implements some factory-like functionality
